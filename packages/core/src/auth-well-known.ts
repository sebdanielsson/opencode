...
export interface Interface {
  readonly all: () => Effect.Effect<Record<string, Entry>, unknown>
  readonly get: (url: string) => Effect.Effect<Entry | undefined, unknown>
  readonly set: (url: string, entry: Entry) => Effect.Effect<void, unknown>
  readonly remove: (url: string) => Effect.Effect<void, unknown>
  readonly metadata: (url: string) => Effect.Effect<Metadata, unknown>
  readonly configs: () => Effect.Effect<ConfigDocument[], unknown>
}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const load: () => Effect.Effect<Record<string, Entry>, unknown> = Effect.fnUntraced(function* () {
